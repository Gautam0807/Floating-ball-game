...
void output(int x, int y,const char* string) //outputs the text on the window
{
	int len, i;
...
void menu() // to create menu
{
	...
	darw_box(200, 350, 260, 290);
	glColor3f(0.0, 0.50, 1.0);
	output(220, 270, "score="); // to display a box with high scores
	char buff[10];
